    ...
    <div id="home" className="relative h-screen w-full overflow-hidden scroll-mt-24">
      {/* <div className='bg-blue-500 w-screen h-16'>Hero</div> */}
        ...
        <motion.div
          ...
          initial={{ opacity: 1 }}     // fully dark
          animate={{ opacity: 0 }}     // fade to reveal gradient
        ...
        <div className="relative z-10 flex flex-col items-center justify-center h-full text-center text-white bottom-35 sm:bottom-40 md:top-10">
          ...
          <motion.h1
            className="text-[23px] mt-80 leading-6 sm:text-[30px] md:text-[32px] lg:text-[40px] sm:mt-100 md:mt-1 sm:leading-8 md:leading-10 afacad-regular"
          ...
          <motion.p
            className="text-[13px] mt-3 sm:text-[13px] md:text-[15px] lg:text-[18px] sm:mt-2 max-w-xl almarai-regular"
            initial={{ opacity: 0, y:0 }} 
            animate={{ opacity: 1, y: 0 }}
